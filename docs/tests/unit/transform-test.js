...
module("Unit | Transform", function(hooks) {
  hooks.beforeEach(function(assert) {
    ...
    fixture.innerHTML = '<div class="environment"><div class="myParent"><div class="target"></div></div></div>';
  ...
  test('Scale then translate', function(assert) {
    target.style.transform = 'scaleX(0.5) scaleY(0.7) translateX(123px) translateY(456px)';
  ...
  test('Translate then scale', function(assert) {
    target.style.transform = 'translateX(123px) translateY(456px) scaleX(0.5) scaleY(0.7)';
