...
import EaListElement from './ea-list-element.js';
...
class AnimatedEach extends Component {
  ...
  */
  ...
  /* eslint-disable ember/require-computed-property-dependencies, ember/no-side-effects */ // turning off these two rules for this method because we manage our own
  ...
  *_ownElements() {
  ...
  static {
    g(this.prototype, "runAnimation", [task(function* (transition, parent, currentSprites, insertedSprites, keptSprites, removedSprites, firstTime) {
      ...
      let context = new TransitionContext(this.durationWithDefault, unmatchedInsertedSprites, unmatchedKeptSprites, unmatchedRemovedSprites, sentSprites, receivedSprites.concat(matchedKeptSprites), beacons, sprite => this._motionStarted(sprite, cycle), sprite => this._motionEnded(sprite, cycle));
